...
urlpatterns = patterns(
    ...
    url(r'^backstage/conflict/deal_conflict$', deal_conflict, name='deal_conflict'),
    url(r'^backstage/untranslate/$', Untranslate.as_view()),
    url(r'^backstage/untranslate/translate_show$', translate_show, name='translate_show'),
    url(r'^backstage/untranslate/trans_submit$', trans_submit, name='trans_submit'),
    url(r'^backstage/untranslate/untrans_search$', untrans_search, name='untrans_search'),
    url(r'^backstage/untranslate/untrans_result$', untrans_result, name='untrans_result'),
    ...
    url(r'^backstage/delete/rules$', rules_delete, name='rules_delete'),
    ...
    url(r'^backstage/rules/custom/export$', custom_export, name='custom_export'),
